...
- **Ultra-Fast Mode**: Average 1.66ms, P95 3.5ms for discovery requests (with advanced optimizations)
- **Throughput**: 27,361+ requests per second under load (50 concurrent users, 5000 iterations)
