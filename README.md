...
- **Ultra-Fast Mode**: Average 1.13ms, P95 2.38ms for discovery requests (with advanced optimizations)
- **Throughput**: 41,174+ requests per second under load (50 concurrent users, 5000 iterations)
