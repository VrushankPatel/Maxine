...
- **Ultra-Fast Mode**: Average 0.78ms, P95 1.46ms for discovery requests (with SIMD optimizations)
- **Throughput**: 57,772+ requests per second under load (50 concurrent users, 5000 iterations)
