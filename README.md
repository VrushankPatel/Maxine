...
- **Ultra-Fast Mode**: Average 1.67ms, P95 7ms for discovery requests
- **Throughput**: 29,862+ requests per second under load (50 concurrent users, 5000 iterations)
- **Lightning Mode**: Average 1.62ms, P95 6ms for discovery requests (50 concurrent users, 5000 iterations)
- **Throughput**: 30,786+ requests per second under load (50 concurrent users, 5000 iterations)
