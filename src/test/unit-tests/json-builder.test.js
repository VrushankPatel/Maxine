...
describe(`${fileName} : JSON Builder Test`, () => {
  it('Building JSON Object by JSONBuilder and checking if it works with all the conditions', (done) => {
    ...
    jsonSample.should.not.have.own.property(
      'sampleKeyShouldNotBeHere',
      'sampleValueShouldNotBeHere'
    );
    ...
    jsonSample.should.have.own.property(
      'keyUnderTrueConditionAgain',
      'valueUnderTrueConditionAgain'
    );
    done();
  });
