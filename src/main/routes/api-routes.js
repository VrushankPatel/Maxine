                                          ...
                                          .get("templates", authenticationController, limiter, listServiceTemplatesController)
                                           ...
                                           .get("intention/get", authenticationController, limiter, getServiceIntentionController)
                                            ...
                                            .get("acl", authenticationController, limiter, listAclPoliciesController)
                                             ...
                                             .post("federation/add", authenticationController, requireRole('admin'), limiter, bodyParser.json(), addFederatedRegistryController)
                                             .post("federation/remove", authenticationController, requireRole('admin'), limiter, bodyParser.json(), removeFederatedRegistryController)
