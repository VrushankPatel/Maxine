...
const { serverListController, registryController, deregisterController, healthController, metricsController, filteredDiscoveryController, discoveryInfoController } = require('../controller/maxine/registry-controller');
