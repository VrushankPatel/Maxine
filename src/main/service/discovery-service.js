...
class DiscoveryService {
  ...
  preloadStrategies() {
    const strategies = [
      {
        key: constants.SSS.RR,
        module: './discovery-services/round-robin-discovery',
        className: 'RoundRobinDiscovery',
      },
      {
        key: constants.SSS.WRR,
        module: './discovery-services/weighted-round-robin-discovery',
        className: 'WeightedRoundRobinDiscovery',
      },
      {
        key: constants.SSS.WRANDOM,
        module: './discovery-services/weighted-random-discovery',
        className: 'WeightedRandomDiscovery',
      },
      {
        key: constants.SSS.LRT,
        module: './discovery-services/least-response-time-discovery',
        className: 'LeastResponseTimeDiscovery',
      },
      {
        key: constants.SSS.FASTEST,
        module: './discovery-services/fastest-discovery',
        className: 'FastestDiscovery',
      },
      {
        key: constants.SSS.CH,
        module: './discovery-services/consistent-hash-discovery',
        className: 'ConsistentHashDiscovery',
      },
      {
        key: constants.SSS.RH,
        module: './discovery-services/rendezvous-hash-discovery',
        className: 'RendezvousHashDiscovery',
      },
      {
        key: constants.SSS.LC,
        module: './discovery-services/least-connections-discovery',
        className: 'LeastConnectionsDiscovery',
      },
      {
        key: constants.SSS.LL,
        module: './discovery-services/least-loaded-discovery',
        className: 'LeastLoadedDiscovery',
      },
      {
        key: constants.SSS.RANDOM,
        module: './discovery-services/random-discovery',
        className: 'RandomDiscovery',
      },
      {
        key: constants.SSS.P2,
        module: './discovery-services/power-of-two-discovery',
        className: 'PowerOfTwoDiscovery',
      },
      {
        key: constants.SSS.ADAPTIVE,
        module: './discovery-services/adaptive-discovery',
        className: 'AdaptiveDiscovery',
      },
      {
        key: constants.SSS.STICKY,
        module: './discovery-services/sticky-discovery',
        className: 'StickyDiscovery',
      },
      {
        key: constants.SSS.LR,
        module: './discovery-services/least-request-discovery',
        className: 'LeastRequestDiscovery',
      },
      {
        key: constants.SSS.PRIORITY,
        module: './discovery-services/priority-discovery',
        className: 'PriorityDiscovery',
      },
      {
        key: constants.SSS.BHS,
        module: './discovery-services/best-health-score-discovery',
        className: 'BestHealthScoreDiscovery',
      },
      {
        key: constants.SSS.GEO,
        module: './discovery-services/geo-discovery',
        className: 'GeoDiscovery',
      },
      {
        key: constants.SSS.PREDICTIVE,
        module: './discovery-services/predictive-discovery',
        className: 'PredictiveDiscovery',
      },
      {
        key: constants.SSS.AFFINITY,
        module: './discovery-services/affinity-discovery',
        className: 'AffinityDiscovery',
      },
      {
        key: constants.SSS.AI_DRIVEN,
        module: './discovery-services/ai-driven-discovery',
        className: 'AiDrivenDiscovery',
      },
    ];
  ...
  cache = new LRUCache({
    max: config.discoveryCacheMax,
    ttl: config.highPerformanceMode ? 7200000 : config.discoveryCacheTTL,
  }); // 2 hours in high perf
  ...
  statefulStrategies = new Set([
    constants.SSS.RR,
    constants.SSS.WRR,
    constants.SSS.LR,
    constants.SSS.RANDOM,
  ]); // Strategies that maintain state or should not be cached for correctness
  ...
  getNode = async (
    ...
    const usesIp = [constants.SSS.CH, constants.SSS.RH, constants.SSS.STICKY].includes(
      config.serverSelectionStrategy
    );
    ...
    if (!cacheKey) {
      cacheKey = usesIp
        ? `${fullServiceName}:${ip}${groupKey}${tagsKey}${deploymentKey}`
        : `${fullServiceName}${groupKey}${tagsKey}${deploymentKey}`;
    ...
    const node = await this.getNodeUncached(
      fullServiceName,
      ip,
      group,
      tags,
  ...
  getNodeUncached = async (
    ...
    if (config.serverSelectionStrategy === constants.SSS.CH) {
      ...
      config.serverSelectionStrategy === constants.SSS.STICKY
    ) {
      node = strategy.getNode(
        fullServiceName,
        ip,
